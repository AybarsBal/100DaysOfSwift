...
class GameScene: SKScene {
    ...
    var explodeButton: SKShapeNode! // added to explode without motionBegan()
    ...
    override func didMove(to view: SKView) {
        ...
        // added to explode without motionBegan()
        ...
        for (index, fireworkContainer) in fireworks.enumerated().reversed() {
            ...
            if firework.name == "selected" {
                ...
                if let fuse = fireworkContainer.childNode(withName: "fuse") {
                    let remove = SKAction.fadeOut(withDuration: 0.2)
    ...
    func gameOver() { // added extra for Challange 2
