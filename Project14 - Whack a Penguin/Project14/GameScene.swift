...
//  Project14
//
//  Created by Yakup Aybars Bal on 22.01.2024.
//
...
class GameScene: SKScene {
    ...
    override func touchesBegan(_ touches: Set<UITouch>, with event: UIEvent?) {
        ...
        for node in tappedNodes {
            ...
            if node.name == "charFriend" {
                ...
                smokeEffect(location: whackSlot.position) // Challenge 3
    ...
    func createEnemy() {
        ...
        if numRounds >= 30 {
            ...
            finalScore.position = CGPoint(x: 512, y: 278)
    ...
    // Challenge 3
    func smokeEffect(location: CGPoint) {
